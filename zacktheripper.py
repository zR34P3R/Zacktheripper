...
logo_design_1 = ('''
_____          _    _   _               _            
|__  /__ _  ___| | _| |_| |__   ___ _ __(_)_ __  _ __   ___ _ __
  / // _` |/ __| |/ / __| '_ \ / _ \ '__| | '_ \| '_ \ / _ \ '__|
 / /| (_| | (__|   <| |_| | | |  __/ |  | | |_) | |_) |  __/ |
/____\__,_|\___|_|\_\\__|_| |_|\___|_|  |_| .__/| .__/ \___|_|
                                          |_|   |_|
...
::   ::   :   {1}( ){0}   :   ::   ::                              
':.  ':.  ':. {1}/_\{0} ,:'  ,:'  ,:'          
 ':.  ':.    {1}/___\{0}    ,:'  ,:'     {1}by R34P3R{0}
  ':.       {1}/_____\{0}      ,:'
           {1}/       \\{0}
'''.format(Fore.GREEN, Fore.WHITE, Fore.RED)

logo_design_pre = '''
RRRRRRRRRRRRRRRRR   IIIIIIIIIIPPPPPPPPPPPPPPPPP   PPPPPPPPPPPPPPPPP
R::::::::::::::::R  I::::::::IP::::::::::::::::P  P::::::::::::::::P
R::::::RRRRRR:::::R I::::::::IP::::::PPPPPP:::::P P::::::PPPPPP:::::P
RR:::::R     R:::::RII::::::IIPP:::::P     P:::::PPP:::::P     P:::::P
  R::::R     R:::::R  I::::I    P::::P     P:::::P  P::::P     P:::::P
  R::::R     R:::::R  I::::I    P::::P     P:::::P  P::::P     P:::::P
  R::::RRRRRR:::::R   I::::I    P::::PPPPPP:::::P   P::::PPPPPP:::::P
  R:::::::::::::RR    I::::I    P:::::::::::::PP    P:::::::::::::PP
  R::::RRRRRR:::::R   I::::I    P::::PPPPPPPPP      P::::PPPPPPPPP
  R::::R     R:::::R  I::::I    P::::P              P::::P
  R::::R     R:::::R  I::::I    P::::P              P::::P
  R::::R     R:::::R  I::::I    P::::P              P::::P
RR:::::R     R:::::RII::::::IIPP::::::PP          PP::::::PP
R::::::R     R:::::RI::::::::IP::::::::P          P::::::::P
R::::::R     R:::::RI::::::::IP::::::::P          P::::::::P
RRRRRRRR     RRRRRRRIIIIIIIIIIPPPPPPPPPP          PPPPPPPPPP                 '''.format(Fore.GREEN, Fore.WHITE, Fore.RED)
...
\033[92m
    ...
    #############
   ###############
   ################. Thanks for installing zacktheripper :)!
  #################
#####################
#####################
  #################'''
...
logo_design_5 = '''
 _    _   _               _
 ______ _  ___| | _| |_| |__   ___ _ __(_)_ __  _ __   ___ _ __
|_  / _` |/ __| |/ / __| '_ \ / _ \ '__| | '_ \| '_ \ / _ \ '__|
 / / (_| | (__|   <| |_| | | |  __/ |  | | |_) | |_) |  __/ |
/___\__,_|\___|_|\_\\__|_| |_|\___|_|  |_| .__/| .__/ \___|_|
                                         |_|   |_|
...
def main():
    page_num = 1
    option = input(Fore.WHITE + "zacktheripper"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
    if option == '1':
        ...
        ip = input(arrow+" zacktheripper"+Fore.RED + "(connect_phone) "+Fore.WHITE + "> ")
        os.system("adb connect "+ip+":5555")
    
    elif option  == '4':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(shell_on_phone) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell")

    elif option == '5':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(apk_install) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter the apk location.").format(Fore.RED, Fore.WHITE))
        apk_location = input("    "+arrow + "zacktheripper"+Fore.RED + "(apk_install) "+Fore.WHITE + "> ")
        os.system("adb -s  "+device_name+" install "+apk_location)
        print (Fore.GREEN  +  "Apk has been installed.")

    elif option ==  '6':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(screen_record) "+Fore.WHITE + "> ")
        print (("     "+connect))
        ...
        place_location = input(arrow +"zacktheripper" +Fore.RED + "(screen_record) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" pull /sdcard/demo.mp4 "+place_location)

    elif option  == '7':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(screenshot) "+Fore.WHITE + "> ")
        ...
        place_location = input("    "+arrow + "zacktheripper"+Fore.RED + "(screenshot) "+Fore.WHITE + "> ")
        ...
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a file location on a device").format(Fore.RED, Fore.WHITE))
        file_location = input("    "+arrow + "zacktheripper"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        print (("        "+connect))
        print (("       [{0}+{1}]Enter where you would like the file to be saved.").format(Fore.RED, Fore.WHITE))
        place_location = input("       "+arrow + "zacktheripper"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" pull "+file_location+" "+place_location)

    elif option == '10':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(device_reboot) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+ " reboot ")
    
    elif option ==  '11':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(app_delete) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name.").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "zacktheripper"+Fore.RED + "(app_delete) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" uninstall "+package_name)

    elif option == '12':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(log) "+Fore.WHITE + "> ")
        os.system('adb -s '+device_name+" logcat ")

    elif option == '13':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(sys_info) "+Fore.WHITE + "> ")
        os.system("adb shell "+device_name+" dumpsys")        

    elif option == '14':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(package_manager) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell pm list packages -f")
        main()

    elif option == '15':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(app_run) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name. They look like this --> com.snapchat.android").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "zacktheripper"+Fore.RED + "(app_run) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell monkey -p "+package_name+" -v 500")
        main()      

    elif option == '16':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a port on the device.").format(Fore.RED, Fore.WHITE))
        port_device = input("    "+arrow + "zacktheripper"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        print (("         "+connect))
        print (("        [{0}+{1}]Enter a port to forward it too.").format(Fore.RED, Fore.WHITE))
        forward_port = input("        "+arrow + "zacktheripper"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        ...
        try:
            ...
            device_name = input(arrow + "zacktheripper"+Fore.RED + "(wpa_grab) "+Fore.WHITE + "> ")
            ...
            location = input("    "+arrow + "zacktheripper"+Fore.RED + "(wpa_grab) "+Fore.WHITE + "> ")      
        ...
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(mac_inet) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell ip address show wlan0")
        main()

    elif option == '19':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name. They look like this --> com.snapchat.android").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "zacktheripper"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        ...
        path = input("        "+arrow + "zacktheripper"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        print (("             "+connect))
        print (("            [{0}+{1}]Enter The location to store the apk: ")  .format(Fore.RED, Fore.WHITE))
        location =   input("            "+arrow + "zacktheripper"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+" pull "+path+" "+location)
        main()

    elif option == '20':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(battery) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell dumpsys battery")
        main()

    elif option == '21':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(net_stat) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell netstat")
        main()

    elif option == '22':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(wifi) "+Fore.WHITE + "> ")
        print (("     "+connect))
        ...
        print (("[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(pass_remove) "+Fore.WHITE + "> ")
        ...
        print (("[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(keycode) "+Fore.WHITE + "> ")
        print ('''
0 -->  "KEYCODE_UNKNOWN" 
1 -->  "KEYCODE_MENU" 
...
85 -->  "TAG_LAST_KEYCODE"        
        ...
        num = input(arrow + "zacktheripper"+Fore.RED + "(keycode) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell input keyevent "+num)

    elif option == '25':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "zacktheripper"+Fore.RED + "(current_activity) "+Fore.WHITE + "> ")
...
def main_linux():
    ...
    try:
        device_name = input (arrow+" zacktheripper"+Fore.RED + "(connect_phone) "+Fore.WHITE + "> ")
    except KeyboardInterrupt:
        main()
    if device_name == '':
        main()
